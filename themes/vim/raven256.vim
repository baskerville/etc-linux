...
" (:h w18)
"
hi Normal          cterm=none ctermfg=45 ctermbg=41
hi Comment         cterm=none ctermfg=44
...
" minor groups
"
hi StatusLine      cterm=none ctermfg=46 ctermbg=43
hi StatusLineNC    cterm=none ctermfg=fg                 ctermbg=43

hi TabLine         cterm=none ctermfg=fg                  ctermbg=43
hi TabLineSel      cterm=none ctermfg=46  ctermbg=43
hi TabLineFill     cterm=none ctermbg=43

hi Pmenu           ctermfg=47       ctermbg=44
hi PmenuSel        ctermfg=bg       ctermbg=fg
hi PmenuSbar       ctermbg=44
...
hi VertSplit       cterm=none ctermfg=43      ctermbg=43
hi LineNr          ctermfg=44   ctermbg=42
hi CursorLineNr    ctermfg=fg                 ctermbg=42

hi Title           ctermfg=30
hi SpecialKey      ctermfg=24
hi Conceal         ctermfg=24       ctermbg=bg
hi NonText         ctermfg=44
hi MatchParen      ctermfg=46   ctermbg=bg  cterm=underline
...
hi Folded          ctermfg=44     ctermbg=40
hi FoldColumn      ctermfg=44     ctermbg=40
hi SignColumn      ctermfg=44     ctermbg=40
hi ColorColumn     ctermfg=44     ctermbg=40

hi CursorColumn    cterm=none ctermbg=42
hi CursorLine      cterm=none ctermbg=42

hi vimFold         ctermfg=44
...
hi diffFile        ctermfg=44
hi diffLine        ctermfg=44
...
hi diffOldLine     cterm=none    ctermfg=bg    ctermbg=44
